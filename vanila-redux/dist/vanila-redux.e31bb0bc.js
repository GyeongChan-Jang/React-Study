...
var btnDecrease = document.querySelector('#decrease'); // 액션의 이름 정의
...
var render = function render() {
  var state = store.getState(); // 현태 상태를 불러옵니다
  // 토글 처리
...
var unsubscribe = store.subscribe(listener); // unsubscribe() // 추후 구독을 비활성화할 때 함수를 호출
// render()
